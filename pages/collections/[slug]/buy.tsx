...
const BuyPage: NextPage = () => {
  ...
  return (
    <>
      ...
      />
      <div className="md:m-5 flex flex-row justify-center">
        <div className="grid grid-cols-2 mt-10">
          <div className="flex justify-center pl-20 pr-5">
          ...
          <div className="flex flex-col justify-center divide-y pl-5 pr-20">
            <div className="pb-5">
              <a
            ...
            <div className="flex-grow pt-5 pb-2">
              <span className="text-sm">
                Offer to buy any{" "}
                <span className="italic">{collection.name}</span> at a price of
              </span>
              ...
              <div className="mt-5">
                <button
                  ...
                  onClick={async () => {
                    ...
                    if (
                      chainId?.valueOf() != process.env.NEXT_PUBLIC_CHAIN_ID
                    ) {
